#!/usr/bin/env python3
"""
User Activity and License Analysis CLI Tool (Simplified Version)
...
This simplified version focuses on core analysis without visualization dependencies.
...
class CLI:
    ...
    def run(self):
        ...
        parser = argparse.ArgumentParser(
            description="User Activity and License Analysis CLI Tool (Simplified Version)",
            formatter_class=argparse.RawDescriptionHelpFormatter,
            epilog="""
Examples:
  python user_activity_analyzer_simple.py --log-file "license logs/log4j-licensing-20250805-0022-03.log.2025-08-05-1"
  python user_activity_analyzer_simple.py --log-file "license logs/*.log" --output-format json
  python user_activity_analyzer_simple.py --log-file "license logs/" --top-percentile 0.1
            """
        )
    ...
    def _process_analysis(self, args):
        ...
        print("🔍 User Activity and License Analysis CLI Tool (Simplified)")
        print("=" * 60)
